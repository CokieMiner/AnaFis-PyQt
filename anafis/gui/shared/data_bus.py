...
from .data_transforms import (
    DataPayload, TabData, create_data_message, validate_data_message,
    serialize_dataframe, deserialize_dataframe, get_data_summary
)
...
class DataBus(QObject):
    ...
    def add_data_filter(
        self, 
        filter_id: str, 
        filter_func: Callable[[DataPayload], bool]
    ) -> None:
        """
    ...
    def get_registered_tabs(self) -> Dict[str, Dict[str, Any]]:
        """
